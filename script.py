...
def military_fort():
    ...
    print("This outpost was built decades ago to seal the cursed cave. Rusty weapons and scattered military journals lie everywhere.")
    print("Available locations: east_sentry | swamp_command | top_headquarters | back")

    while True:
        cmd = input("fort> ")
        if cmd == "back":
            print("You leave the military fort and return to the northern road area.")
            break
        elif cmd == "east_sentry":
            if not soldier_task_done:
                print("\n[Soldier (Ghost)]")
                print("I lost my military ration pack in the eastern woods. I cannot hold this sentry post without supplies.")
                sub_cmd = input("choice: help | loot | leave\n")
                if sub_cmd == "help":
                    if "some food" in have_list:
                        ...
                        print("You hand over your food. The soldier gives you a military bronze key for the armory.")
                        print("Head to the swamp command post and ask the lieutenant for the march password.")
                    else:
                        print("You carry no food to offer.")
                elif sub_cmd == "loot":
                    evil += 12
                    hp -= 3
                    print("You steal military supplies and trigger an old trap. The soldier becomes hostile toward you.")
                elif sub_cmd == "leave":
                    continue
            else:
                print("The soldier stands guard quietly, his request has been fulfilled.")
        elif cmd == "swamp_command":
            if not lieutenant_task_done:
                print("\n[Lieutenant (Ghost)]")
                print("The march password is split into three fragments recorded in garrison journals.")
                print("Puzzle: The three seal locations are forest graveyard altar. Enter the first letter of each rune in uppercase order.")
                ...
                if ans == "R1R2R3":
                    ...
                    good += 10
                    trap_protect = True
                    print("Password verified. You gain full trap immunity within the misty swamp.")
                else:
                    hp -= 5
                    print("Wrong code. Poison gas leaks and injures you.")
            else:
                print("Deliver all three garrison journals to the colonel at the top headquarters to uncover hidden historical truth.")
        elif cmd == "top_headquarters":
            if colonel_diary_collected < 3:
                print("\n[Colonel (Ghost)]")
                print("Return to me once you have collected all three military garrison journals. I will reveal the official record of the cave seal.")
            else:
                print("You submit all journals. The colonel narrates the sealed history of your family's eternal guardianship.")
                good += 15
                have_list.append("military archive document")
                print("You obtain classified archive files which unlock a hidden military ending route.")
        else:
...
def orc_tribe_dungeon():
    ...
    while True:
        ...
        if cmd == "back":
            ...
            evil += 30
            hp -= 8
            print("You attack the tribe and seize gold treasures, but gain heavy evil karma. All orcs will stay hostile in subsequent playthroughs.")
        else:
            print("Unknown command.")
...
def hill():
    ...
    while True:
        ...
        if cmd == 'climb':
            ...
            print('Nothing special, just some butterflies.')
...
def gamestart():
    ...
    print('You see a road lead to south.')
...
def main():
    ...
    if m == 1:
        if d == 1:
            ...
            print("\n=====================================")
            print("🤝 BOND FESTIVAL 🤝")
            print("Warmth connects, loneliness fades.")
            print("=====================================\n")
            good += 12
            hp += 4
        elif d == 26:
    ...
    if game_back == False:
        if not args.godmode:
            ...
            print('Then, you become a mortrol who has the power of a god.')
        ...
        if cleared_ending == True:
            if play_count == 2:
                ...
                print('Our cuse will be broken by you.')
                ...
                print('Welcome to the last but not least part of death adventure.')
